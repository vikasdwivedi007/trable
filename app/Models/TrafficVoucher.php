...
class TrafficVoucher extends Model
{
    ...
    public static function vouchersIndex()
    {
        ...
        ])->leftJoin('job_files as job_file', 'traffic_vouchers.job_id', '=', 'job_file.id');
    ...
    {
        return route('traffic-vouchers.show', ['traffic_voucher' => $this->id]);
    }
