...
class GiftPolicy
{
    ...
    {
        return $user->hasPermission(Gift::PERMISSION_NAME, 'read');
    }
    ...
    {
        return $user->hasPermission(Gift::PERMISSION_NAME, 'write');
    }
    ...
    {
        return ($user->hasPermission(Gift::PERMISSION_NAME, 'write') && $gift->canBeDeleted());
    }
