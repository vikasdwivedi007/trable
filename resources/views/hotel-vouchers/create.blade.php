        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('main.create_new_hotel_voucher')}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('hotel-vouchers.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="res_type" id="radio-Hotel" value="2" checked>
                            ...
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="res_type" id="radio-Cruise" value="1" >
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Arrival-Date" class="form-control" placeholder="{{__('main.arrival_date')}}" name="arrival_date" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Departure-Date" class="form-control"
                                           placeholder="{{__('main.departure_date')}}" name="departure_date" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="single_rooms_count"  id="No-Single-Rooms" class="form-control" placeholder="{{__('main.number_of_single_rooms')}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{__("main.number_of_double_rooms")}}</label>
                                    <input type="text"  name="double_rooms_count" id="No-Double-Rooms" class="form-control" placeholder="{{__('main.number_of_double_rooms')}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{__("main.number_of_triple_rooms")}}</label>
                                    <input type="text"  name="triple_rooms_count" id="No-Triple-Rooms" class="form-control" placeholder="{{__('main.number_of_triple_rooms')}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{__("main.number_of_suite_rooms")}}</label>
                                    <input type="text"  name="suite_rooms_count" id="No-Suite-Rooms" class="form-control" placeholder="{{__('main.number_of_suite_rooms')}}">
                                </div>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="day_item row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-day-num="1" class="Day-Date form-control" name="meals[1][date]" placeholder="{{__('main.date')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-7" style="margin-top: 2rem;">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-fill d-inline">
                                            <input type="hidden" name="meals[1][american_breakfast]" value="0">
                                            <input type="checkbox" name="meals[1][american_breakfast]"
                                                   id="checkbox-fill-American-Breakfast-1" value="1">
                                            <label for="checkbox-fill-American-Breakfast-1"
                                                   class="cr">{{__('main.american_breakfast')}}</label>
                                        </div>
                                        <div class="checkbox checkbox-fill d-inline">
                                            <input type="hidden" name="meals[1][continental_breakfast]" value="0">
                                            <input type="checkbox" name="meals[1][continental_breakfast]"
                                                   id="checkbox-fill-Continental-Breakfast-1" value="1">
                                            <label for="checkbox-fill-Continental-Breakfast-1"
                                                   class="cr">{{__('main.continental_breakfast')}}</label>
                                        </div>
                                        <div class="checkbox checkbox-fill d-inline">
                                            <input type="hidden" name="meals[1][lunch]" value="0">
                                            <input type="checkbox" name="meals[1][lunch]"
                                                   id="checkbox-fill-Lunch-1" value="1">
                                            <label for="checkbox-fill-Lunch-1"
                                                   class="cr">{{__('main.lunch')}}</label>
                                        </div>
                                        <div class="checkbox checkbox-fill d-inline">
                                            <input type="hidden" name="meals[1][dinner]" value="0">
                                            <input type="checkbox" name="meals[1][dinner]"
                                                   id="checkbox-fill-Dinner-1" value="1">
                        ...
                        <button id="save-voucher" type="submit" class="btn btn-primary">{{__('main.create')}}</button>
