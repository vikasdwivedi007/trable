        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{ route('lkfriends.update', ['lkfriend'=>$lkfriend->id]) }}" method="POST">
                        @method("PATCH")
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Name-of-Like-Friend" class="form-control @error('name') is-invalid @enderror"
                                           name="name" placeholder="{{__('main.name')}}" required value="{{$lkfriend->name}}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mob_no @error('phone') is-invalid @enderror"
                                           name="phone" placeholder="{{__('main.phone')}}"  required value="{{$lkfriend->phone}}">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="LanguageDDL" class="js-example-basic-multiple " multiple="multiple" name="languages[]" required >
                                        ...
                                        @foreach($languages as $language)
                                            <option value="{{$language->id}}" @if($lkfriend->languages->contains($language->id))selected @endif>{{$language->language}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="CityDDL"
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{$city->id}}" @if($city->id == $lkfriend->city_id) selected @endif>{{$city->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('city_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="Fees-Per-Day" type="text" class="form-control autonumber @error('rent_day') is-invalid @enderror"
                                           name="rent_day"
                                           placeholder="{{__('main.fees_per_day')}}"  value="{{$lkfriend->rent_day}}">
                                    @error('rent_day')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="CurrencyCDDL1"
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($lkfriend->rent_day_currency == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="Selling-Fees-Freind" type="text" class="form-control autonumber @error('sell_rent_day_vat_exc') is-invalid @enderror"
                                           ...
                                           placeholder="{{__('main.selling_fees_per_day')}}"  value="{{$lkfriend->sell_rent_day_vat_exc}}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="CurrencyCDDL2"
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($lkfriend->sell_rent_day_currency == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
