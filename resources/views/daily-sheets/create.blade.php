        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('main.daily_sheets_add_new')}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="#!">
                                ...
                                <div class="form-group">
                                  <label>{{__('main.select_date')}} </label>
                                    <input type="text" id="date" class="form-control"
                                            placeholder="{{__('main.select_date')}}" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="job_item">
                                <div class="row">
                                    ...
                                    <div class="col-md-2" style="margin-top: 2rem;">
                                        <button type="button" class="btn btn-primary show_data_btn" onclick="loadFileData($(this));return false;">{{__('main.show_details')}}</button>
                                    </div>
                                    <div class="col-md-2 remove_item d-none">
                                        <button type="button" class="btn btn-danger" onclick="$(this).closest('.job_item').remove();return false;">{{__('main.remove_item')}}</button>
                                    </div>
                                </div>
                                <div class="row item_details justify-content-center d-none">
                                    <div id="fileDetls" class="bg-light col-sm-12 px-2 py-3 py-4 mx-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label class="text-info text-uppercase">{{__('pax_count')}}</label>
                                                <div class="form-group">
                                                    <input type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox checkbox-fill d-inline mr-4">
                                                        <input type="checkbox"
                                                               ...
                                                               name="service_conciergerie" class="concierge">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text"  class="form-control driver_phone"
                                                           name="validation-required"
                                                           placeholder="{{__('main.driver_phone')}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select
                                                        ...
                                                        @foreach($reps as $rep)
                                                            <option value="{{$rep->id}}" data-phone="{{$rep->user->phone}}">{{$rep->user->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" class="form-control representative_phone"
                                                           name="validation-required"
                                                           placeholder="{{__('main.transfer_man_phone')}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <button type="submit" id="saveData_btn" onclick="saveData('{{route("daily-sheets.store")}}', 'POST');return false;" class="btn btn-primary">{{__('main.create')}}</button>
