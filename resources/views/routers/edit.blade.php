        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{ route('routers.update', ['router'=>$router->id]) }}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="SN-Devices" class="form-control @error('serial_no') is-invalid @enderror"
                                           name="serial_no" placeholder="{{__("main.serial_no")}}" value="{{$router->serial_no}}" required>
                                    @error('serial_no')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="No-of-Router" class="form-control @error('number') is-invalid @enderror"
                                           name="number" placeholder="{{__("main.number_of_router")}}"  value="{{$router->number}}" required>
                                    @error('number')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Package-Quota" class="form-control @error('quota') is-invalid @enderror"
                                           name="quota" placeholder="{{__("main.package_quota")}} (GB)"  value="{{$router->quota}}" required>
                                    @error('quota')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="ServiceProviderDDL"
                                        ...
                                        <option value="1" @if($router->provider == 1) selected @endif>Etislat</option>
                                        <option value="2" @if($router->provider == 2) selected @endif>Orange</option>
                                        <option value="3" @if($router->provider == 3) selected @endif>Vodafone</option>
                                        <option value="4" @if($router->provider == 4) selected @endif>WE</option>
                                    </select>
                                    @error('provider')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="CityDDL"
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{$city->id}}" @if($router->city_id == $city->id) selected @endif>{{$city->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('city_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="router-buy-pric" type="text" class="form-control autonumber @error('package_buy_price') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.buying_price")}}" value="{{$router->package_buy_price}}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($router->package_buy_currency == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="router-sell-pric" type="text" class="form-control autonumber @error('package_sell_price_vat_exc') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.selling_price")}}" value="{{$router->package_sell_price_vat_exc}}" >
                                ...
                                <div class="form-group">
                                  <label>{{__('main.currency')}}</label>
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($router->package_sell_currency == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
