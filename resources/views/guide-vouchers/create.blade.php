        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('main.create_new_guide_voucher')}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('guide-vouchers.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="Guide-Name"
                                        ...
                                        @foreach($guides as $guide)
                                            <option value="{{$guide->id}}" data-langs="{{$guide->languages_str}}" data-phone="{{$guide->phone}}">{{$guide->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Guide-Address" class="form-control"
                                           placeholder="{{__('main.guide_address')}}" name="guide_address">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Guide-Phone-Number" class="form-control"
                                           placeholder="{{__('main.tour_guide_phone')}}" disabled>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select id="Hotel-Name"
                                            class="js-example-tags form-control"
                                            name="hotel_id" disabled required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__("main.room_number")}}</label>
                                    <input type="text" id="Client-Room-Number" class="form-control"
                                           name="room_no" placeholder="{{__('main.room_number')}}" disabled>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Transportation-By" class="form-control" placeholder="{{__('main.transportation_by')}}" name="transport_by">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" id="Number-of-PAX" class="form-control"
                                           placeholder="{{__('main.pax_count')}}" name="pax_no" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Tour-Operator" class="form-control"
                                           placeholder="{{__('main.tour_operator')}} *" name="tour_operator" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="tour-item">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="tours[0][date]" type="text" id="Tour-Date" class="Tour-Date form-control" placeholder="{{__('main.tour_date')}} *" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="#" onclick="addTourItem();return false;">+ {{__('main.add_new_item')}}</a>
                                        <br>
                                        <a class="remove-item" style="display: none;" href="#" onclick="$(this).closest('.tour-item').remove();return false;">- {{__('main.remove_item')}}</a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            <textarea  name="tours[0][desc]" class="form-control" rows="6" required ></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="issue_date" type="text" id="Date-of-Issue" class="form-control" placeholder="{{__('main.date_of_issue')}} *" required>
                                </div>
                            </div>
                        </div>
