        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__("main.create_new_slshow")}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{ route('slshows.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">                                    
                                    ...
                                    <select id="CityDDL"
                                        ...
                                        <option value="Pyramids" @if(old('place') == 'Pyramids') selected @endif>Pyramids</option>
                                        <option value="Karnak" @if(old('place') == 'Karnak') selected @endif>Karnak</option>
                                        <option value="Edfu" @if(old('place') == 'Edfu') selected @endif>Edfu</option>
                                        <option value="Philae" @if(old('place') == 'Philae') selected @endif>Philae</option>
                                        <option value="Abu Simbel" @if(old('place') == 'Abu Simbel') selected @endif>Abu Simbel</option>
                                    </select>
                                    @error('place')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date-sond-ligt-Show" class="form-control @error('date') is-invalid @enderror"
                                           name="date" placeholder="{{__("main.date")}}" required value="{{old('date')}}">
                                    @error('date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="time-of-show" class="form-control @error('time') is-invalid @enderror" placeholder="{{__("main.time")}}" name="time" required value="{{old('time')}}">
                                @error('time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="LanguageDDL" class="js-example-basic-multiple @error('language_id') is-invalid @enderror" name="language_id" required>
                                        ...
                                        @foreach($languages as $language)
                                            <option value="{{$language->id}}" @if($language->id == old('language_id')) selected @endif>{{$language->language}}</option>
                                        @endforeach
                                        <option value="{{\App\Models\Language::ALL_LANGUAGES_ID}}" @if(old('language_id') == \App\Models\Language::ALL_LANGUAGES_ID) selected @endif>All Languages</option>
                                    </select>
                                    @error('language_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <fieldset class="form-group ">
                                ...
                                <div class="form-group d-inline">
                                    ...
                                    <div class="radio radio-primary d-inline">                                         
                                        <input type="radio" name="ticket_type" id="radio-p-Male" @if(!old('ticket_type'))checked=""@endif  value="Regular">
                                        <label for="radio-p-Male" class="cr">Regular</label>
                                    </div>
                                </div>
                                <div class="form-group d-inline">
                                    <div class="radio radio-primary d-inline">                                        
                                        <input type="radio" name="ticket_type" id="radio-p-Female" @if(old('ticket_type') == "VIP") checked="" @endif value="VIP">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="adult-buy-pric" type="text" class="form-control autonumber @error('buy_price_adult') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.buying_price")}}"  value="{{old('buy_price_adult')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if(old('adult_buy_currency') == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="adult-sell-pric" type="text" class="form-control autonumber @error('sell_price_adult_vat_exc') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.selling_price")}}"  value="{{old('sell_price_adult_vat_exc')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if(old('adult_sell_currency') == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="child-buy-pric" type="text" class="form-control autonumber @error('buy_price_child') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.buying_price")}}"  value="{{old('buy_price_child')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if(old('child_buy_currency') == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="child-sell-pric" type="text" class="form-control autonumber @error('sell_price_child_vat_exc') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.selling_price")}}"  value="{{old('sell_price_child_vat_exc')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if(old('child_sell_currency') == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
