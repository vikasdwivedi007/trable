        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__("main.create_work_order")}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('work-orders.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>{{__("main.create")}}</button>
