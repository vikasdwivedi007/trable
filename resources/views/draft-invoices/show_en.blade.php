...
<div class="main">
    <table class="T0">
        ...
        <tr>
            <td class="text-center bold prFont-20">
                Draft Invoice No
                <input type="text" value="{{$draftInvoice->number}}" class="ToA bold md-font">
            </td>
            <!-- <td></td> -->
        </tr>
    ...
    <table class="Table-half">
        ...
        <tr>
            <td>
                <p class="fw-700"> <span class="fw-900">Sender:</span> VOYAGEURS DU MONDE- EGYPT<br />
    ...
    <table class="Table-half xHeight">
        ...
        <tr>
            ...
            <td><input type="text" value="{{$draftInvoice->job_file->command_no}}" class="To bold md-font"></td>
        </tr>
        </tbody>
    </table>
    <table class="Table-half">
        ...
        <tr>
            ...
            <td>
                <input type="text" value="{{$draftInvoice->job_file->travel_agent->name}}" class="To bold md-font">
            </td>

        </tr>
        <tr>
            <td width="10%"></td>
            <td><input type="text" value="{{$draftInvoice->job_file->travel_agent->address}}" class="To bold md-font"></td>
    ...
    <table class="Table-half xHeight-62">
        <tbody>
        <tr>
            <td width="16%" class="bold">Name:
            </td>
            <td><input type="text" value="{{$draftInvoice->job_file->client_name}}" class="To bold md-font"></td>
        </tr>
        </tbody>
    </table>
    <table class="Table-half">
        ...
        <tr>
            <td width="40%">
                <p class="fw-900">Draft Invoice Date: </p>
            </td>
            <td>
                <input type="text" value="{{$draftInvoice->job_file->arrival_date->format('d F Y')}}" class="To bold md-font">
            </td>
    ...
    <table class="Table-half">
        ...
        <tr>
            ...
            <td><input type="text" value="{{$draftInvoice->job_file->arrival_date->format('d/m/Y')}}" class="To bold md-font"></td>
            <td width="16%" class="bold">DEP:</td>
            <td><input type="text" value="{{$draftInvoice->job_file->departure_date->format('d/m/Y')}}" class="To bold md-font"></td>
        </tr>
        </tbody>
    </table>
    <table class="t1">
        ...
        <tr height="50">
            ...
            <td width="10%" class="text-center bold border-top border-right">
                <input type="text" class="text-center input1" value="{{$draftInvoice->total_without_vat}} {{\App\Models\Currency::currencyName($draftInvoice->currency, true)}}" readonly="">
            </td>
        ...
        <tr height="50">
            ...
            <td width="10%" class="text-center bold border-top border-right">
                <input type="text" class="text-center input1" value="{{$draftInvoice->total - $draftInvoice->total_without_vat}} {{\App\Models\Currency::currencyName($draftInvoice->currency, true)}}" readonly="">
            </td>
            <td width="10%" class="text-center bold">
            </td>
        </tr>
        <tr height="50">
            ...
            <td width="10%" class="text-center bold  border-top">
                <input type="text" class="text-center input1" value="{{$draftInvoice->total}} {{\App\Models\Currency::currencyName($draftInvoice->currency, true)}}" readonly="">
            </td>
        </tr>
