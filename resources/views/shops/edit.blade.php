        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('shops.update', ['shop'=>$shop->id])}}" method="POST"  enctype="multipart/form-data">
                        @method("PATCH")
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="NameOfShop" class="form-control @error('name') is-invalid @enderror"
                                           name="name" placeholder="{{__("main.name")}}" required value="{{$shop->name}}">
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                           name="address" placeholder="{{__("main.address")}}" required value="{{$shop->address}}">
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <label>{{__('main.phone')}}</label>
                                    <input type="text" class="form-control mob_no @error('phone') is-invalid @enderror"
                                           name="phone" placeholder="{{__("main.phone")}}"  required value="{{$shop->phone}}">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="Percentage" type="text" class="form-control autonumber @error('commission') is-invalid @enderror"
                                           ...
                                           placeholder="{{__("main.percentage")}}"  required value="{{$shop->commission}}">
                                    @error('commission')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="card-header">
                            ...
                            @if($shop->file)
                                <a href="{{url(\Illuminate\Support\Facades\Storage::url($shop->file->url))}}" target="_blank" style="font-size:20px;">(<i class="feather icon-file"></i>)</a>
                            @endif
                        </div>
                        <div class="row">
