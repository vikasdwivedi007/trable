        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{ route('rooms.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="date-Valid-From" class="form-control @error('price_valid_from') is-invalid @enderror" 
                                      name="price_valid_from" required value="{{old('price_valid_from')}}" placeholder="{{__("main.price_valid_from")}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="date-Valid-To" class="form-control @error('price_valid_to') is-invalid @enderror" 
                                      name="price_valid_to" required value="{{old('price_valid_to')}}" placeholder="{{__("main.price_valid_to")}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Room-Name" class="form-control @error('name') is-invalid @enderror" name="name"  required value="{{old('name')}}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="hid-shw" class="form-group">
                                    ...
                                    <select id="RoomCategDDL" class="js-example-tags form-control @error('view') is-invalid @enderror" name="view" required>
                                        ...
                                        <option value="Garden View" @if(old('view') == 'Garden View') selected @endif>Garden View</option>
                                        <option value="Nile View" @if(old('view') == 'Nile View') selected @endif>Nile View</option>
                                        <option value="Pool View" @if(old('view') == 'Pool View') selected @endif>Pool View</option>
                                        <option value="Pyramids View" @if(old('view') == 'Pyramids View') selected @endif>Prymids View</option>
                                    </select>
                                    @error('view')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">                                            
                                            <input type="radio" name="type" id="radio-SGL" value="1" class="@error('type') is-invalid @enderror" required @if(!old('type') || old('type') == 1) checked="" @endif>
                                    ...
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="type" id="radio-DBL" value="2" @if(old('type') == 2) checked="" @endif>
                                            <label for="radio-DBL" class="cr">Double</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="type" id="radio-TRPL" value="3" @if(old('type') == 3) checked="" @endif>
                                            <label for="radio-TRPL" class="cr">Triple</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="type" id="radio-Quad" value="4" @if(old('type') == 4) checked="" @endif>
                                            <label for="radio-Quad" class="cr">Quad</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="type" id="radio-King" value="6" @if(old('type') == 6) checked="" @endif>
                                            <label for="radio-King" class="cr">King</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="type" id="radio-Twin" value="7" @if(old('type') == 7) checked="" @endif>
                                            <label for="radio-Twin" class="cr">Twin</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="type" id="radio-Suite" value="8" @if(old('type') == 8) checked="" @endif>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="meal_plan" id="radio-BB" value="1" class="@error('meal_plan') is-invalid @enderror" required @if(!old('meal_plan') || old('meal_plan') == 1) checked="" @endif>
                                    ...
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="meal_plan" id="radio-HB" value="2" @if(old('meal_plan') == 2) checked="" @endif>
                                            <label for="radio-HB" class="cr">HB</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="meal_plan" id="radio-FB" value="3" @if(old('meal_plan') == 3) checked="" @endif>
                                            <label for="radio-FB" class="cr">FB</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="meal_plan" id="radio-AI" value="4" @if(old('meal_plan') == 4) checked="" @endif>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea placeholder="{{__("main.room_info")}}" class="form-control @error('info') is-invalid @enderror" rows="10" name="info">{{old('info')}}</textarea>
                                @error('info')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="Room-Base-Rate" class="form-control autonumber @error('base_rate') is-invalid @enderror" value="{{old('base_rate')}}"
                                       name="base_rate"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="CurrenciesDDL"
                                            ...
                                            @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                                <option value="{{$key}}" @if(old('base_rate_currency') == $key) selected @endif>{{$value}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="discount_type" id="radio-Amount" value="2" class="@error('discount_type') is-invalid @enderror" @if(!old('discount_type') || old('discount_type') == 2) checked="" @endif>
                                    ...
                                    <input type="text" id="discount-Amount" class="form-control autonumber @error('discount_value') is-invalid @enderror"
                                           name="discount_value_amount" value="{{old('discount_value_amount')}}" @if(old('discount_type') == 1) disabled @endif>
                            ...
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="discount_type" id="radio-Precentage" value="1" class="@error('discount_type') is-invalid @enderror" @if(old('discount_type') == 1) checked="" @endif>
                                    ...
                                    <input type="text" id="discount-precentage" class="form-control autonumber @error('discount_value') is-invalid @enderror"
                                           name="discount_value_perc"  data-a-sign="% " value="{{old('discount_value_perc')}}" @if(!old('discount_type') || old('discount_type') == 2) disabled @endif>
                                    @error('discount_value')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div id="CancelationAdded" class="row">
                            ...
                            @if(old('cancels'))
                                @foreach(old('cancels') as $key => $value)
                                    ...
                                    <div class="col-md-3 pt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="Cancel-Amount" class="form-control autonumber Cancel-Amount"
                                                   name="cancels[{{$key}}][cancel_value_amount]" @if($value['type'] == 2) value="{{$value['cancel_value_amount']}}" @else disabled @endif>
                                    ...
                                    <div class="col-md-3 pt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="Cancel-precentage" class="form-control autonumber Cancel-precentage @error("cancels.{$key}.value") is-invalid @enderror"
                                                   name="cancels[{{$key}}][cancel_value_perc]"  data-a-sign="% " @if($value['type'] == 1) value="{{$value['cancel_value_perc']}}" @else disabled @endif>
                                            @error("cancels.{$key}.value")
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            @elseif(isset($ssss))
                                <div class="cancel-item row">
                                    <div class="col-md-3 pt-2">
                                        <div class="form-group">
                                            <div class="radio radio-primary d-inline">
                                                <input type="radio" name="cancels[0][type]" id="radio-Cancel-Amount" class="radio-Cancel-Amount" value="Cancel-Amount" checked="">
                                                <label for="radio-Cancel-Amount" class="cr">{{__('main.amount')}}</label>
                                            </div>

                                            <input type="text" id="Cancel-Amount" class="form-control autonumber Cancel-Amount"
                                                   name="cancels[0][cancel_value_amount]">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 pt-2">
                                        <div class="form-group">
                                            <div class="radio radio-primary d-inline">
                                                <input type="radio" name="cancels[0][type]" id="radio-Cancel-Precentage" class="radio-Cancel-Precentage" value="Precentage">
                                                <label for="radio-Cancel-Precentage" class="cr">{{__('main.percentage')}}</label>
                                            </div>

                                            <input type="text" id="Cancel-precentage" class="form-control autonumber Cancel-precentage"
                                                   name="cancels[0][cancel_value_perc]"  data-a-sign="% " disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-2 pt-2">
                                        <label  class="cr">Period Time</label>
                                        <div class="form-group">
                                            <select id="CurrenciesDisDDL"
                                                    class="js-example-tags form-control"
                                                    name="cancels[0][time]">
                                                <option value="1">{{__('main.before')}} 1 {{__('main.day')}}</option>
                                                <option value="2">{{__('main.before')}} 2 {{__('main.days')}}</option>
                                                <option value="3">{{__('main.before')}} 3 {{__('main.days')}}</option>
                                                <option value="4">{{__('main.before')}} 4 {{__('main.days')}}</option>
                                                <option value="5">{{__('main.before')}} 5 {{__('main.days')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2 align-self-center">
                                        <div class="form-group pt-4">
                                            <a href="#" onclick="addNewCancelFees('{{__('main.amount')}}', '{{__('main.percentage')}}', '{{__('main.period_time')}}', '{{__('main.before')}}', '{{__('main.day')}}', '{{__('main.days')}}', '{{__('main.remove_period_time')}}');return false;">
                                                + {{__("main.add_new_period_time")}}
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <input type="text" id="Extra-Bed-Adult" class="form-control autonumber @error('extra_bed_exc') is-invalid @enderror" name="extra_bed_exc"  value="{{old('extra_bed_exc')}}">
                                    @error('extra_bed_exc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <input type="number" id="No-child-with-adults" class="form-control @error('max_children_with_two_parents') is-invalid @enderror" name="max_children_with_two_parents"  value="{{old('max_children_with_two_parents')}}">
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <input type="text" id="Single-parent-Adultt" class="form-control autonumber @error('child_with_two_parents_exc') is-invalid @enderror" name="child_with_two_parents_exc"  value="{{old('child_with_two_parents_exc')}}">
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <input type="text" id="Single-Parent-Adult" class="form-control autonumber @error('single_parent_exc') is-invalid @enderror" name="single_parent_exc"  value="{{old('single_parent_exc')}}">
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <input type="text" id="Single-parent-Child" class="form-control autonumber @error('single_parent_child_exc') is-invalid @enderror"  value="{{old('single_parent_child_exc')}}" name="single_parent_child_exc">
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <select id="childFreeDDL"
                                        ...
                                        <option value="3" @if(old('child_free_until') == 3) selected @endif>3</option>
                                        <option value="4" @if(old('child_free_until') == 4) selected @endif>4</option>
                                        <option value="5" @if(old('child_free_until') == 5) selected @endif>5</option>
                                        <option value="6" @if(old('child_free_until') == 6) selected @endif>6</option>
                                    </select>
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <select id="MinChildDDL"
                                        ...
                                        <option value="3" @if(old('min_child_age') == 3) selected @endif>6</option>
                                        <option value="4" @if(old('min_child_age') == 4) selected @endif>7</option>
                                        <option value="5" @if(old('min_child_age') == 5) selected @endif>8</option>
                                    </select>
                                    @error('min_child_age')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-2 align-self-center">
                                <div class="form-group">
                                    <select id="MaxChildDDL"
                                        ...
                                        <option value="10" @if(old('max_child_age') == 10) selected @endif>10</option>
                                        <option value="11" @if(old('max_child_age') == 11) selected @endif>11</option>
                                        <option value="12" @if(old('max_child_age') == 12) selected @endif>12</option>
                                        <option value="13" @if(old('max_child_age') == 13) selected @endif>13</option>
                                    </select>
                                    @error('max_child_age')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="row pt-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="{{__("main.promo_special_offers")}}" class="form-control @error('special_offer') is-invalid @enderror" name="special_offer" rows="10">{{old('special_offer')}}</textarea>
                                    @error('special_offer')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
<script>
    var next_cancel = 1;
    @if(old('cancels'))
        next_cancel = {{max(array_keys(old('cancels'))) + 1}};
    @endif
