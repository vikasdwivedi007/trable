        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{ route('employees.update', ['employee'=>$employee->id]) }}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="EmployeeName" class="form-control  @error('name') is-invalid @enderror"
                                           name="name" placeholder="{{__('main.name')}}" required value="{{$employee->user->name}}">
                                    @error('name')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="EmployeeNameAr" class="form-control ar_only @error('name_ar') is-invalid @enderror"
                                           name="name_ar" placeholder="{{__('main.name_ar')}}" required value="{{$employee->user->name_ar}}">
                                    @error('name_ar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="LanguageDDL" class="js-example-basic-multiple"
                                        ...
                                        @foreach($languages as $language)
                                            <option value="{{$language->id}}" @if($employee->languages->contains($language->id))selected @endif>{{$language->language}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mob_no @error('phone') is-invalid @enderror"
                                           name="phone" placeholder="{{__('main.phone')}}" required value="{{$employee->user->phone}}">
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('email') is-invalid @enderror"
                                           name="email" placeholder="{{__('main.email')}}" required value="{{$employee->user->email}}">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                           name="address" placeholder="{{__('main.address')}}" required value="{{$employee->user->address}}">
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div id="hid-shw" class="form-group">
                                    ...
                                    <select id="jobTitleDDL"
                                        ...
                                        @foreach($job_titles as $job_title)
                                            <option value="{{$job_title->id}}" @if($job_title->id == $employee->job_id) selected @endif>{{$job_title->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="supervisorJobTitleDDL"
                                        ...
                                        @foreach($available_supervisors as $job_title)
                                            <option value="{{$job_title->id}}" @if($job_title->id == $employee->supervisor_id) selected @endif>{{$job_title->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date-Hiring" class="form-control @error('hired_at') is-invalid @enderror"
                                           name="hired_at" placeholder="{{__('main.date_of_hiring')}}" value="{{$employee->hired_at ? $employee->hired_at->format('Y-m-d') : ""}}">
                                    @error('hired_at')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date-Promotion" class="form-control @error('promoted_at') is-invalid @enderror"
                                           name="promoted_at" placeholder="{{__('main.date_of_promotion')}}" value="{{$employee->promoted_at ? $employee->promoted_at->format('Y-m-d') : ""}}">
                                    @error('promoted_at')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control autonumber @error('salary') is-invalid @enderror"
                                           ...
                                           placeholder="{{__('main.salary')}}"  required  value="{{$employee->salary}}">
                                    @error('salary')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control autonumber @error('points') is-invalid @enderror"
                                           name="points" placeholder="{{__('main.points')}}" value="{{$employee->points}}">
                                    @error('points')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <fieldset class="form-group ">
                                    ...
                                    <div class="form-group d-inline">
                                        ...
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="gender" id="radio-p-Male" @if($employee->gender == 0)checked=""@endif  value="0">
                                            <label for="radio-p-Male" class="cr">{{__('main.male')}}</label>
                                        </div>
                                    </div>
                                    <div class="form-group d-inline">
                                        <div class="radio radio-primary d-inline">
                                            <input type="radio" name="gender" id="radio-p-Female" @if($employee->gender == 1)checked=""@endif value="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group d-inline">
                                    ...
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="outsource" id="radio-p-fill-5" value="1" @if($employee->outsource == 1)checked=""@endif>
                                        <label for="radio-p-fill-5" class="cr">{{__('main.yes')}}</label>
                                    </div>
                                </div>
                                <div class="form-group d-inline">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="outsource" id="radio-p-fill-6"  value="0" @if($employee->outsource == 0)checked=""@endif>
                                        ...
                                        <div class="checkbox checkbox-fill d-inline">
                                            <input type="checkbox" name="permissions[{{$permission->name}}][read]"
                                                   id="checkbox-fill-{{$permission->name}}-read"
                                                    @if($employee->user->hasPermission($permission->name, 'read')) checked @endif>
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox checkbox-fill d-inline">
                                            <input type="checkbox" name="permissions[{{$permission->name}}][write]"
                                                   ...
                                                   @if($employee->user->hasPermission($permission->name, 'write')) checked @endif>
