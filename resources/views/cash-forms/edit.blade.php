        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('main.update_cash_form')}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('cash-forms.update', ['cash_form'=>$cashForm->id])}}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                  <label>{{__('main.request_date')}}</label>
                                    <input type="text" id="date" class="form-control"
                                           name="date" placeholder="{{__('main.request_date')}}" value="{{$cashForm->toArray()['date']}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="service-Fees" class="form-control autonumber" data-a-sign="EGP "
                                           name="additional_fees" placeholder="{{__('main.additional_service_fees')}}" value="{{$cashForm->additional_fees}}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"
                                              ...
                                              placeholder="{{__('main.additional_service_description')}}" required>{{$cashForm->additional_desc}}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                                    ...
                                    <select id="filesNoDDL"
                                        ...
                                        @foreach($job_files as $job_file)
                                            <option value="{{$job_file->id}}"
                                                    @if($job_file->id == $cashForm->job_id) selected @endif
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="repDDL"
                                        ...
                                        @foreach($reps as $rep)
                                            <option @if($cashForm->emp_id == $rep->id) selected @endif value="{{$rep->id}}">{{$rep->user->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
