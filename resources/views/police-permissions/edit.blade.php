        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__("main.update_police_permission")}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('police-permissions.update', ['police_permission'=>$policePermission->id])}}" method="POST">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="FileNo" class="form-control"
                                           name="file_no" placeholder="{{__("main.file_no")}} *" value="{{$policePermission->job_file->file_no}}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Travel-Agent-NameAr" class="form-control drtl ar_only"
                                           name="travel_agent_ar" value="{{$policePermission->travel_agent_ar}}" required placeholder="رجاء كتابة أسم شركة السياحة بالعربي">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="float-right">العميل قادم من</label>
                                    <input type="text" id="Coming-From" class="form-control drtl ar_only"
                                           name="coming_from_ar" value="{{$policePermission->coming_from_ar}}" required placeholder="رجاء كتابة العميل قادم من">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <label class="float-right">أسم العميل</label>
                                    <input type="text" id="client_name_ar" class="form-control drtl ar_only"
                                           name="client_name_ar"  value="{{$policePermission->client_name_ar}}" required placeholder="رجاء كتابة أسم العميل بالعربي">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Nationality-GroupAr" class="form-control drtl ar_only"
                                           name="nationality_ar" value="{{$policePermission->nationality_ar}}" required placeholder="رجاء كتابة جنسية العميل بالعربي">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                  <label>{{__("main.company_of_transportation")}}</label>
                                    <select id="TrnsprtDDL"
                                        ...
                                        <option value="">Transportation Company Name *</option>
                                        @foreach($transportations as $transportation)
                                            <option value="{{$transportation->id}}" @if($transportation->id == $policePermission->transportation_id) selected @endif>{{$transportation->name_ar ?: $transportation->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="Guide-Name"
                                        ...
                                        @foreach($guides as $guide)
                                            <option value="{{$guide->id}}" data-phone="{{$guide->phone}}" @if($guide->id == $policePermission->guide_id) selected @endif>{{$guide->name_ar ?: $guide->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Guide-Phone-Number" class="form-control"
                                           name="validation-required" placeholder="{{__("main.tour_guide_phone")}}" value="{{$policePermission->guide->phone}}" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="Trnsprt-Representative-Name"
                                        ...
                                        @foreach($employees as $employee)
                                            <option value="{{$employee->id}}" data-phone="{{$employee->user->phone}}" @if($employee->id == $policePermission->representative_id) selected @endif>{{$employee->user->name_ar ?: $employee->user->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Trnsprt-Representative-Mobile" class="form-control"
                                           name="validation-required" placeholder="{{__("main.representative_phone")}}" value="{{$policePermission->representative->user->phone}}" disabled>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="Trnsprt-Driver-Name"
                                        ...
                                        @foreach($available_drivers as $driver)
                                            <option value="{{$driver->id}}" data-phone="{{$driver->driver_phone}}" @if($driver->id == $policePermission->driver_id) selected @endif>{{$driver->driver_name_ar ?: $driver->driver_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Trnsprt-Driver-Mobile" class="form-control"
                                           name="validation-required" placeholder="{{__("main.driver_phone")}}" value="{{$policePermission->driver ? $policePermission->driver->driver_phone : ""}}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="row form-group">
                                    ...
                                    <label class="float-right">أرقام</label>
                                      ...
                                      <input type="text" class="form-control Trnsprt-Car-Plate-No"
                                               name="car_no_seg[0]" maxlength="4" @isset($car_no_seg[0]) value="{{$car_no_seg[0]}}" @endif required>
                                    </div>
                                    <div class="col-md-2">
                                      <label class="float-right">حرف</label>  
                                      <input type="text" class="form-control Trnsprt-Car-Plate-No"
                                               name="car_no_seg[1]" maxlength="1" @isset($car_no_seg[1]) value="{{$car_no_seg[1]}}" @endif required>
                                    </div>
                                    <div class="col-md-2">
                                      <label class="float-right">حرف</label>  
                                      <input type="text"  class="form-control Trnsprt-Car-Plate-No "
                                               name="car_no_seg[2]" maxlength="1" @isset($car_no_seg[2]) value="{{$car_no_seg[2]}}" @endif required>
                                    </div>
                                    <div class="col-md-2">
                                      <label class="float-right">حرف</label>  
                                      <input type="text"  class="form-control Trnsprt-Car-Plate-No"
                                               name="car_no_seg[3]" maxlength="1" @isset($car_no_seg[3]) value="{{$car_no_seg[3]}}" @endif required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label for="">{{__("main.date")}}</label>
                                            <input type="text" class="form-control traffic_line_date"
                                                   name="traffic_lines[{{$loop->index}}][date]" placeholder="{{__("main.date")}}" value="{{$line->toArray()['date']}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group float-right">
                                            ...
                                            <br>
                                            <a class="remove-item" @if($loop->first) style="display: none;" @endif href="#" onclick="$(this).closest('.traffic-item').remove();return false;">- {{__("main.remove")}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label for="">{{__("main.traffic_line_details")}}</label>
                                            <textarea class="form-control" rows="6"
                                                      name="traffic_lines[{{$loop->index}}][details]" placeholder="{{__("main.traffic_line_details")}}" required>{{$line->details}}</textarea>
                                        </div>
                                    </div>
                        ...
                        <button type="submit" id="save-btn" class="btn btn-primary" disabled>{{__("main.update")}}</button>
...
@section('script_bottom')
    <script>
            ...
            $.post('{{route('job-files.searchByFileNo')}}', {'file_no': file_no})
                .done(function (data) {
                    if(data.job_file){
                        ...
                        $("#Travel-Agent-NameAr").val("{{$policePermission->travel_agent_ar}}");
                        $("#Coming-From").val("{{$policePermission->coming_from_ar}}");
                        $("#Nationality-GroupAr").val("{{$policePermission->nationality_ar}}");
                        $("#client_name_ar").val("{{$policePermission->client_name_ar}}");
                ...
                .done(function(data){
                    if(data.cars){
                        for(var i=0;i<data.cars.length;i++){
                            var car = data.cars[i];
                            $("#Trnsprt-Driver-Name").append('<option value="'+car.id+'" data-phone="'+car.driver_phone+'">'+car.driver_name+'</option>');
                        }
                        $("#Trnsprt-Driver-Name").select2();
        ...
        var current_item = {{$policePermission->traffic_lines->count()}} + 1;
