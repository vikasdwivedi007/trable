            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="#!">
                        ...
                        <div class="row mt-4">
                            <button type="submit" id="saveData_btn" onclick="saveData('{{route("operator-assignments.store")}}', 'POST');return false;" class="btn btn-primary">{{__("main.create")}}</button>
