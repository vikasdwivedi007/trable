        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{__('main.update_nile_cruise')}}</h5>
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('nile-cruises.update', ['nile_cruise'=>$nile_cruise->id])}}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Name-of-Company" class="form-control @error('company_name') is-invalid @enderror"
                                           name="company_name" placeholder="{{__('main.company_name')}}" required value="{{$nile_cruise->company_name}}">
                                    @error('company_name')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="Name-of-Nile-Cruise" class="form-control @error('name') is-invalid @enderror"
                                           name="name" placeholder="{{__('main.name_of_nile_cruise')}}" required value="{{$nile_cruise->name}}">
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="date-Cruise-Check-in" class="form-control @error('date_from') is-invalid @enderror"
                                       name="date_from" placeholder="{{__('main.check_in_date')}}" required value="{{$nile_cruise->toArray()['date_from']}}">
                                @error('date_from')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="date-Cruise-Check-out" class="form-control @error('date_to') is-invalid @enderror"
                                       name="date_to" placeholder="{{__('main.check_out_date')}}" required value="{{$nile_cruise->toArray()['date_to']}}">
                                @error('date_to')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="CityFromDDL"
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{$city->id}}" @if($city->id == $nile_cruise->from_city_id) selected @endif>{{$city->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('from_city_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="CityToDDL"
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{$city->id}}" @if($city->id == $nile_cruise->to_city_id) selected @endif>{{$city->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('to_city_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="cabin_type" id="radio-Cabin" value="cabin" @if($nile_cruise->cabin_type == 'cabin') checked="" @endif>
                            ...
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="cabin_type" id="radio-Suite" value="suite"  @if($nile_cruise->cabin_type == 'suite') checked="" @endif>
                        ...
                        <div class="row">
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="deck_type" id="radio-Main-Deck" value="main" @if($nile_cruise->deck_type == 'main') checked="" @endif >
                            ...
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="deck_type" id="radio-Upper-Deck" value="upper" @if($nile_cruise->deck_type == 'upper') checked="" @endif >
                        ...
                        <div class="row">
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="including_sightseeing" id="radio-Including-Sightseeing" value="1" @if($nile_cruise->including_sightseeing ) checked="" @endif>
                            ...
                            <div class="col-md-3 pt-2">
                                <div class="form-group">
                                    <div class="radio radio-primary d-inline">
                                        <input type="radio" name="including_sightseeing" id="radio-Not-Including-Sightseeing" value="0" @if(!$nile_cruise->including_sightseeing ) checked="" @endif >
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="SGL-Cabin-buy-pric" type="text" class="form-control autonumber @error('sgl_buy_price') is-invalid @enderror"
                                           name="sgl_buy_price"
                                           placeholder="{{__('main.buying_price')}}"  value="{{$nile_cruise->sgl_buy_price}}">
                                    @error('sgl_buy_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->sgl_buy_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="SGL-Cabin-sell-pric" type="text" class="form-control autonumber @error('sgl_sell_price') is-invalid @enderror"
                                           name="sgl_sell_price"
                                           placeholder="{{__('main.selling_price')}}"  value="{{$nile_cruise->sgl_sell_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->sgl_sell_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="DBL-Cabin-buy-pric" type="text" class="form-control autonumber @error('dbl_buy_price') is-invalid @enderror"
                                           name="dbl_buy_price"
                                           placeholder="{{__('main.buying_price')}}"  value="{{$nile_cruise->dbl_buy_price}}">
                                    @error('dbl_buy_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->dbl_buy_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="DBL-Cabin-sell-pric" type="text" class="form-control autonumber @error('dbl_sell_price') is-invalid @enderror"
                                           name="dbl_sell_price"
                                           placeholder="{{__('main.selling_price')}}"  value="{{$nile_cruise->dbl_sell_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->dbl_sell_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="trpl_buy_price" type="text" class="form-control autonumber @error('trpl_buy_price') is-invalid @enderror"
                                           name="trpl_buy_price"
                                           placeholder="{{__('main.buying_price')}}"  value="{{$nile_cruise->trpl_buy_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->trpl_buy_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="trpl_sell_price" type="text" class="form-control autonumber @error('trpl_sell_price') is-invalid @enderror"
                                           name="trpl_sell_price"
                                           placeholder="{{__('main.selling_price')}}"  value="{{$nile_cruise->trpl_sell_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->trpl_sell_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="Children-buy-pric" type="text" class="form-control autonumber @error('child_buy_price') is-invalid @enderror"
                                           name="child_buy_price"
                                           placeholder="{{__('main.buying_price')}}"  value="{{$nile_cruise->child_buy_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->child_buy_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="Children-sell-pric" type="text" class="form-control autonumber @error('child_sell_price') is-invalid @enderror"
                                           name="child_sell_price"
                                           placeholder="{{__('main.selling_price')}}"  value="{{$nile_cruise->child_sell_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->child_sell_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="Buy-Privt-Salary" type="text" class="form-control autonumber @error('private_guide_salary') is-invalid @enderror"
                                           name="private_guide_salary"
                                           placeholder="{{__('main.salary')}}" value="{{$nile_cruise->private_guide_salary}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="Sell-Privt-Acc" type="text" class="form-control autonumber @error('private_guide_accommodation') is-invalid @enderror"
                                           name="private_guide_accommodation"
                                           placeholder="{{__('main.accommodation')}}" value="{{$nile_cruise->private_guide_accommodation}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="Buy-Privt-Tur-Gid-pric" type="text" class="form-control autonumber @error('private_guide_buy_price') is-invalid @enderror"
                                           name="private_guide_buy_price"
                                           placeholder="{{__('main.buying_price')}}" value="{{$nile_cruise->private_guide_buy_price}}" disabled>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->private_buy_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="Sell-Privt-Tur-Gid-pric" type="text" class="form-control autonumber @error('private_guide_sell_price') is-invalid @enderror"
                                           name="private_guide_sell_price"
                                           placeholder="{{__('main.selling_price')}}" value="{{$nile_cruise->private_guide_sell_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->private_sell_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="Buy-Gid-boat-pric" type="text" class="form-control autonumber @error('boat_guide_buy_price') is-invalid @enderror"
                                           name="boat_guide_buy_price"
                                           placeholder="{{__('main.buying_price')}}" value="{{$nile_cruise->boat_guide_buy_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->boat_guide_buy_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input id="Sell-Gid-boat-pric" type="text" class="form-control autonumber @error('boat_guide_sell_price') is-invalid @enderror"
                                           name="boat_guide_sell_price"
                                           placeholder="{{__('main.selling_price')}}" value="{{$nile_cruise->boat_guide_sell_price}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($nile_cruise->boat_guide_sell_currency == $key) selected @endif >{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
