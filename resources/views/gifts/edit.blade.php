        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="validation-form123" action="{{route('gifts.update', ['gift'=>$gift->id])}}" method="POST"  >
                        @method("PATCH")
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control @error('name') is-invalid @enderror"
                                           name="name" placeholder="{{__('main.name_of_gift')}}" required value="{{$gift->name}}">
                                    @error('name')
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="adult-buy-pric" type="text" class="form-control autonumber @error('buy_price') is-invalid @enderror"
                                           name="buy_price"
                                           placeholder="{{__('main.buying_price')}}"  value="{{$gift->buy_price}}">
                                    @error('buy_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                      ...
                                      <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($gift->buy_currency == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                                    @error('buy_currency')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control autonumber @error('sell_price') is-invalid @enderror"
                                           name="sell_price"
                                           placeholder="{{__('main.selling_price')}}"  value="{{$gift->sell_price}}">
                                    @error('sell_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                      ...
                                      <select
                                        ...
                                        @foreach(\App\Models\Currency::availableCurrencies() as $key => $value)
                                            <option value="{{$key}}" @if($gift->sell_currency == $key) selected @endif>{{$value}}</option>
                                        @endforeach
                                    </select>
                                    @error('sell_currency')
                                    <span class="invalid-feedback" role="alert">
